<?php
    class Checkout
    {
        ...
        function save()
        {
            ...
            //     "INSERT INTO book_copies (book_copy_id, patron_id, checkout_date, due_date, returned_date, comment, still_out) VALUES
        ...
        static function getSome($search_selector, $search_argument = '')
        {
            ...
            //     $statement_handle = $GLOBALS['DB']->prepare(
            //         "SELECT * FROM book_copies ORDER BY book_copy_id, id;"
            //     );
            // }
            //
            // $output = array();
